...
void print_help(char* plain_flag){
    if(strcmp(plain_flag,"plain")==0){
        printf("[ -INFO- ] Usage: hpcopr Command PARAM1 PARAM2 ...\n");
        printf("| Commands:\n");
        ...
        printf("|        ECHO_FLAG    - Specify 'echo' as the last param to echo the ak/sk.\n");
        ...
        printf("|      (Optional)all|TARGET_CLUSTER_NAME - Default to glance the current cluster.\n");
        printf("|  refresh     : Refresh the target cluster without changing the resources.\n");
        printf("|      (Optional)TARGET_CLUSTER_NAME (Optional)force\n");
        printf("|        Specify 'force' as the 3rd param to do force-refresh ( DANGER! ).\n");
        printf("|  exit-current: Exit the current cluster.\n");
        printf("|  remove      : Completely remove a cluster from the OS and registry.\n");
        printf("|      TARGET_CLUSTER_NAME (Optional)force\n");
        printf("|        Specify 'force' as the 3rd param to do force-remove ( DANGER! ).\n");
        ...
        printf("|      (Optinal)print(default)|read (Optional)EXPORT_DEST\n");
        ...
        printf("|      USER_NAME (Optional)CLUSTER_NAME\n"); 
        printf("|        USER_NAME    - Must specify to log in as which user. For example: user1.\n");
        printf("|        CLUSTER_NAME - Keep it blank to log in the current cluster. \n");
        ...
        printf("|      (Optional)NEW_CONFIG (Optinal)HT_FLAG\n");
        ...
        printf("|      TARGET_CLUSTER_NAME (Optional)force\n");
        printf("|        Specify 'force' as the 3rd param to do force-remove " WARN_YELLO_BOLD "( DANGER! )" RESET_DISPLAY ".\n");
