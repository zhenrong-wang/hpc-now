...
extern char URL_ALICLOUD_ROOT[LOCATION_LENGTH];
extern char URL_AWS_ROOT[LOCATION_LENGTH];
extern char URL_QCLOUD_ROOT[LOCATION_LENGTH];
extern char URL_SHELL_SCRIPTS[LOCATION_LENGTH];
extern char URL_NOW_CRYPTO[LOCATION_LENGTH];
extern int REPO_LOC_FLAG;
extern int TEMPLATE_LOC_FLAG_ALI;
extern int TEMPLATE_LOC_FLAG_AWS;
extern int TEMPLATE_LOC_FLAG_QCLOUD;
